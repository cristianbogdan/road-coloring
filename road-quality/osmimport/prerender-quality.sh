...
ls -1 /tmp/stache/template/712-* | xargs -n1 -P4 tilestache-seed.py -c quality.cfg -l tiles -e png -q -x --tile-list 
...
ls -1 /tmp/stache/template/712-* | xargs -n1 -P4 tilestache-seed.py -c edit.cfg -x -e json -l roads -q --tile-list
