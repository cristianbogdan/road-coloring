...
function loadDoc(zoom) {
    ...
    var osmUrl = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
        ...
        roadQUrl1= MAP_ROOT+'/infraGraphic1/{z}/{x}/{y}.png',
        roadQUrl2= MAP_ROOT+'/infraGraphic2/{z}/{x}/{y}.png',
        roadQUrl3= MAP_ROOT+'/infraGraphic3/{z}/{x}/{y}.png',
        roadQUrl4= MAP_ROOT+'/infraGraphic4/{z}/{x}/{y}.png',
        roadQUrl5= MAP_ROOT+'/infraGraphic5/{z}/{x}/{y}.png',
        roadQUrl6= MAP_ROOT+'/infraGraphic6/{z}/{x}/{y}.png',
        roadQUrl7= MAP_ROOT+'/infraGraphic7/{z}/{x}/{y}.png',
        roadQUrl8= MAP_ROOT+'/infraGraphic8/{z}/{x}/{y}.png',
